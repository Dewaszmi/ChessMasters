...
from .views import auth, student, trainer
...
urlpatterns = [
    ...
    path(
        "trainer/results/student/<int:user_id>/", trainer.student_detail_view, name="trainer_student_detail"
    ),
    path(
        "trainer/results/student/<int:user_id>/module/<int:module_id>/",
        trainer.student_module_detail_view,
        name="trainer_student_module_detail",
    ),
    path("ajax/create-group/", trainer.ajax_create_group, name="ajax_create_group"),
    path("ajax/assign-student/", trainer.ajax_assign_student, name="ajax_assign_student"),
]
